...
ActiveRecord::Schema[7.1].define(version: 2024_01_04_090250) do
  ...
  create_table "currencies", force: :cascade do |t|
    t.string "code"
    t.decimal "value"
    t.bigint "currency_update_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["currency_update_id"], name: "index_currencies_on_currency_update_id"
  end
  ...
  add_foreign_key "currencies", "currency_updates"
end
